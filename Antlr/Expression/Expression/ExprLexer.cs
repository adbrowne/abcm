...
public partial class ExprLexer : Lexer {
    ...
    public void mID() // throws RecognitionException [2]
    {
            ...
            int _type = ID;
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // C:\\data\\code\\abcm\\Antlr\\Expression\\Expression\\Expr.g:48:5: ( ( 'a' .. 'z' | 'A' .. 'Z' )+ )
            // C:\\data\\code\\abcm\\Antlr\\Expression\\Expression\\Expr.g:48:9: ( 'a' .. 'z' | 'A' .. 'Z' )+
            {
            	// C:\\data\\code\\abcm\\Antlr\\Expression\\Expression\\Expr.g:48:9: ( 'a' .. 'z' | 'A' .. 'Z' )+
            	int cnt1 = 0;
            	do 
    ...
    public void mINT() // throws RecognitionException [2]
    {
            ...
            int _type = INT;
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // C:\\data\\code\\abcm\\Antlr\\Expression\\Expression\\Expr.g:49:5: ( ( '0' .. '9' )+ )
            // C:\\data\\code\\abcm\\Antlr\\Expression\\Expression\\Expr.g:49:9: ( '0' .. '9' )+
            {
            	// C:\\data\\code\\abcm\\Antlr\\Expression\\Expression\\Expr.g:49:9: ( '0' .. '9' )+
            	int cnt2 = 0;
            	do 
    ...
    public void mNEWLINE() // throws RecognitionException [2]
    {
            ...
            int _type = NEWLINE;
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // C:\\data\\code\\abcm\\Antlr\\Expression\\Expression\\Expr.g:50:8: ( ( '\\r' )? '\\n' )
            // C:\\data\\code\\abcm\\Antlr\\Expression\\Expression\\Expr.g:50:9: ( '\\r' )? '\\n'
            {
            	// C:\\data\\code\\abcm\\Antlr\\Expression\\Expression\\Expr.g:50:9: ( '\\r' )?
            	int alt3 = 2;
    ...
    public void mWS() // throws RecognitionException [2]
    {
            ...
            int _type = WS;
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // C:\\data\\code\\abcm\\Antlr\\Expression\\Expression\\Expr.g:51:5: ( ( ' ' | '\\t' )+ )
            // C:\\data\\code\\abcm\\Antlr\\Expression\\Expression\\Expr.g:51:9: ( ' ' | '\\t' )+
            {
            	// C:\\data\\code\\abcm\\Antlr\\Expression\\Expression\\Expr.g:51:9: ( ' ' | '\\t' )+
            	int cnt4 = 0;
            	do 
