...
public partial class ExprParser : Parser
{
    ...
    // $ANTLR start "atom"
    // C:\\data\\code\\abcm\\Antlr\\Expression\\Expression\\Expr.g:36:1: atom returns [int value] : ( INT | ID | '(' expr ')' );
    ...
    {   
        ...
        try 
    	{
            // C:\\data\\code\\abcm\\Antlr\\Expression\\Expression\\Expr.g:37:5: ( INT | ID | '(' expr ')' )
            int alt5 = 3;
            switch ( input.LA(1) ) 
            {
            case INT:
            ...
            switch (alt5) 
            {
                case 1 :
                    ...
                    {
                    	INT4=(IToken)Match(input,INT,FOLLOW_INT_in_atom244); 
                    	value =  int.Parse(((INT4 != null) ? INT4.Text : null));

                    }
                    break;
                case 2 :
                    // C:\\data\\code\\abcm\\Antlr\\Expression\\Expression\\Expr.g:38:9: ID
                    {
                    	ID5=(IToken)Match(input,ID,FOLLOW_ID_in_atom256); 

                    	        int v = memory[((ID5 != null) ? ID5.Text : null)];
                    	        if ( v!=null ) value =  v;
                    	        else Console.WriteLine("undefined variable "+((ID5 != null) ? ID5.Text : null));
                    	        

                    }
                    break;
                case 3 :
                    // C:\\data\\code\\abcm\\Antlr\\Expression\\Expression\\Expr.g:44:9: '(' expr ')'
                    {
                    	Match(input,12,FOLLOW_12_in_atom276); 
                    	PushFollow(FOLLOW_expr_in_atom278);
                    	expr6 = expr();
                    	state.followingStackPointer--;

                    	Match(input,13,FOLLOW_13_in_atom280); 
                    	value =  expr6;
    ...
    public static readonly BitSet FOLLOW_stat_in_prog37 = new BitSet(new ulong[]{0x0000000000001072UL});
    ...
    public static readonly BitSet FOLLOW_8_in_stat80 = new BitSet(new ulong[]{0x0000000000001060UL});
    ...
    public static readonly BitSet FOLLOW_9_in_expr145 = new BitSet(new ulong[]{0x0000000000001060UL});
    public static readonly BitSet FOLLOW_multExpr_in_expr149 = new BitSet(new ulong[]{0x0000000000000602UL});
    public static readonly BitSet FOLLOW_10_in_expr165 = new BitSet(new ulong[]{0x0000000000001060UL});
    ...
    public static readonly BitSet FOLLOW_11_in_multExpr212 = new BitSet(new ulong[]{0x0000000000001060UL});
    public static readonly BitSet FOLLOW_atom_in_multExpr216 = new BitSet(new ulong[]{0x0000000000000802UL});
    public static readonly BitSet FOLLOW_INT_in_atom244 = new BitSet(new ulong[]{0x0000000000000002UL});
    public static readonly BitSet FOLLOW_ID_in_atom256 = new BitSet(new ulong[]{0x0000000000000002UL});
    public static readonly BitSet FOLLOW_12_in_atom276 = new BitSet(new ulong[]{0x0000000000001060UL});
    public static readonly BitSet FOLLOW_expr_in_atom278 = new BitSet(new ulong[]{0x0000000000002000UL});
    public static readonly BitSet FOLLOW_13_in_atom280 = new BitSet(new ulong[]{0x0000000000000002UL});
